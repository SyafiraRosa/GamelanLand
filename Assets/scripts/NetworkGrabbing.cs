...
public class NetworkGrabbing : MonoBehaviourPunCallbacks, IPunOwnershipCallbacks
{
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (gameObject.name == "Pelog Penerus Pemukul Kiri")
            {
                gameObject.layer = 9;
            }
            else if (gameObject.name == "Pelog Barung Pemukul Kiri")
            {
                gameObject.layer = 9;
            }
            else if (gameObject.name == "Pelog Gong Pemukul")
            {
                gameObject.layer = 9;
            }
            else if (gameObject.name == "Pelog Kenong Pemukul Kiri")
            {
                gameObject.layer = 9;
            }
            else
